function SaveItem() {
	...
	var name = document.forms.ProjectList.name.value;
	var data = document.forms.ProjectList.data.value;
...
function ModifyItem() {
	var name = document.forms.ProjectList.name.value;
	document.forms.ProjectList.data.value = localStorage.getItem(name);
	doShowAll();
}

function RemoveItem() {
	var name = document.forms.ProjectList.name.value;
	document.forms.ProjectList.data.value = localStorage.removeItem(name);
	doShowAll();
}
